...
# verbosity:
#     If 0: Print out pc integers, one per line
#     If 1: Print out pc integers, all on one line
#     If 2: Print out pc integers, all on one line, then pitch numbers (middle C = 60), all on one line
#     If 3: Print out ontimes, pitches, and sd's, one note on each line (a "notelist")
